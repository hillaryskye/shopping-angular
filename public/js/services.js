app.factory('ShoppingService', function() {
...
TeaList.addTea = function(tea) {
  TeaList.cart.push(tea);
  console.log('teaList', TeaList)
  console.log('tealist cart', TeaList.cart)

}

TeaList.removeTea = function(tea) {
  console.log('delete from service')

  var index = TeaList.cart.indexOf(tea);
